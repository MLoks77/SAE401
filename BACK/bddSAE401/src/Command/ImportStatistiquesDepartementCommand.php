...
// https://docs.google.com/document/d/172NAMJ7iW0pV-AnZcYcjySHTZBIs16OYetdVZH20Jvg/edit?tab=t.0#heading=h.87m3tg78js6k
// TP LE, Back TD1 (partie 2) SAE401
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        while (($row = fgetcsv($handle, 0, $separator)) !== false) {
            ...
            if (($i % $batchSize) === 0 && $i > 0) {
                $this->em->flush();
                $this->em->clear(Population::class, Logements::class);
            }

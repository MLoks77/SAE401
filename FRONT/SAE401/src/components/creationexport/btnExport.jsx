...
const BtnExport = ({ chartRef }) => {
    ...
    return (
        <div className="p-2">
            <button onClick={exportpng} className="p-4 w-full bg-blue-800 hover:bg-blue-700 text-white font-bold py-4 rounded-lg transition-colors min-w-60 cursor-pointer active:scale-[0.98]">
